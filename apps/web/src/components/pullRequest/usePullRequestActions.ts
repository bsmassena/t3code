...
const ACTION_SUCCESS_LABELS: Record<PullRequestAction, string> = {
  ...
  "enable-auto-merge": "Auto-merge turned on",
...
const ACTION_FAILURE_HINTS: Record<PullRequestAction, string> = {
  ...
  "update-branch":
    "The host refused it. Check that you have write access to the branch and that it does not conflict with the base.",
  "enable-auto-merge":
    "The host refused it. Check that this repository allows auto-merge and that you have write access.",
  "disable-auto-merge":
