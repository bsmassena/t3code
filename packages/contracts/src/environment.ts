...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server exposes staged and unstaged review sources plus their file actions. Absent on older
      servers, so clients keep those sources disabled under version skew. */
  localReviewSources: Schema.optionalKey(Schema.Boolean),
